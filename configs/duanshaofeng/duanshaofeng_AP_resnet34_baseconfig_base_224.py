...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/AP/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/AP/annotation/instance_all.json',
        split='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/trainlist_1.txt',
    ...
    val=dict(
        ...
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/AP/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/AP/annotation/instance_all.json',
        split='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/testlist_1.txt',
