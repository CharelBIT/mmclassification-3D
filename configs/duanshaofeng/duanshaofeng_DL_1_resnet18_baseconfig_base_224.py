...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/DL/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/DL/annotation/instance_all.json',
