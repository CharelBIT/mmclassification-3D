...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/M/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/Deep-VMHCC/coco/M/annotation/instance_all.json',
