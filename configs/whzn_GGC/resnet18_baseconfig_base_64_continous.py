...
train_pipeline = [
    ...
    dict(type='CropWithAnnotation',
         ...
         debug='/gruntdata1/charelchen.cj/workDir/dataset/whzn_lung/coco/CropWithAnnotation_train'),
...
test_pipeline = [
    ...
    dict(type='CropWithAnnotation',
         ...
         debug='/gruntdata1/charelchen.cj/workDir/dataset/whzn_lung/coco/CropWithAnnotation_test'
         ),
    dict(type='Resize', size=(64, 64)),
    dict(type='Normalize', **img_norm_cfg),
    dict(type='ImageToTensor', keys=['img']),
...
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/whzn_GGC_resnet18_baseconfig_base_64_continous'
