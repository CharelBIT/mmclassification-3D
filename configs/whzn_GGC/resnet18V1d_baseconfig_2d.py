...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_dir='/gruntdata/workDir/dataset/GGN/2d_Slices/image',
        ann_file='/gruntdata/workDir/dataset/GGN/2d_Slices/annotation/instance_all.json',
        split='/gruntdata/workDir/dataset/GGN/train.txt',
    ...
    val=dict(
        ...
        img_dir='/gruntdata/workDir/dataset/GGN/2d_Slices/image',
        ann_file='/gruntdata/workDir/dataset/GGN/2d_Slices/annotation/instance_all.json',
        split='/gruntdata/workDir/dataset/GGN/test.txt',
