...
log_level = 'INFO'
load_from = '/gruntdata1/charelchen.cj/workDir/dataset/mmclassifcation_pretrained_model/resnet34_batch256_imagenet_20200708-32ffb4f7.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/whzn_GGC_resnet34_baseconfig_base_224_continous_full_data_augment'
