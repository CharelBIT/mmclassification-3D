...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/coco/T2/image',
            ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/coco/T2/annotation/instance_all.json',
            split='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/trainlist.txt',
    ...
    val=dict(
        ...
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/coco/T2/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/coco/T2/annotation/instance_all.json',
        split='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/testlist.txt',
...
log_level = 'INFO'
load_from = '/opt/data/private/project/charelchen.cj/workDir/dataset/mmclassifcation_pretrained_model/resnet50_batch256_imagenet_20200708-cfb998bf.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/whzn_prostate_resnet50_baseconfig_base_224_continous_full_data_augment_T2'
