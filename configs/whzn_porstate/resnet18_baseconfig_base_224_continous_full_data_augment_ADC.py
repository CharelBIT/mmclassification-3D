...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/coco/ADC/image',
            ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whzn_prostate/coco/ADC/annotation/instance_all.json',
...
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/whzn_prostate_resnet18_baseconfig_base_224_continous_full_data_augment_ADC'
