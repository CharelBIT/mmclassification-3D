...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/hie/train_sample.txt',
    ...
    val=dict(
        ...
        data_prefix='/opt/data/private/project/charelchen.cj/workDir/dataset/hie/'
                    'hie_resample_0.5x0.5x0.5_niigz',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/hie/val_sample.txt',
