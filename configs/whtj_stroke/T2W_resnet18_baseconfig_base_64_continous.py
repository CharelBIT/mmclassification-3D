...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        type=dataset_type,
        img_dir='/gruntdata1/charelchen.cj/workDir/dataset/whtj_stroke/coco/t2/image',
        ann_file='/gruntdata1/charelchen.cj/workDir/dataset/whtj_stroke/coco/t2/annotation/instance_all.json',
...
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/whtj_stroke_T2W_resnet18_baseconfig_base_64_continous'
