...
# yapf:enable
checkpoint_config = dict(by_epoch=True, interval=4)
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = None
resume_from = '/opt/data/private/project/charelchen.cj/workDir/project/mmclassification/work_dirs/resnetV1d18_baseconfig/epoch_2168.pth'
workflow = [('train', 1)]
