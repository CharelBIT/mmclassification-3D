...
data = dict(
    ...
    train=dict(
        ...
        split='/opt/data/private/project/charelchen.cj/workDir/dataset/whtj_lung/train_split_130_label2.txt',
    ...
    val=dict(
        ...
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whtj_lung/2dSlice_continous/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whtj_lung/2dSlice_continous/annotation/instance_all.json',
        split='/opt/data/private/project/charelchen.cj/workDir/dataset/whtj_lung/val_split_130_label2.txt',
    ...
    test=dict(
        ...
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whtj_lung/2dSlice_continous/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whtj_lung/2dSlice_continous/annotation/instance_all.json',
        ssplit='/opt/data/private/project/charelchen.cj/workDir/dataset/whtj_lung/test_split_130_label2.txt',
        pipeline=test_pipeline,
        ))
