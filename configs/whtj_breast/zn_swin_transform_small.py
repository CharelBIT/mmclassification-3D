...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_dir='/gruntdata/workDir/dataset/whtj_breast/coco/zn/image',
        ann_file='/gruntdata/workDir/dataset/whtj_breast/coco/zn/annotation/instance_all.json',
        split='/gruntdata/workDir/dataset/whtj_breast/zn_trainlist.txt',
    ...
    val=dict(
        ...
        img_dir='/gruntdata/workDir/dataset/whtj_breast/coco/zn/image',
        ann_file='/gruntdata/workDir/dataset/whtj_breast/coco/zn/annotation/instance_all.json',
        split='/gruntdata/workDir/dataset/whtj_breast/zn_testlist.txt',
