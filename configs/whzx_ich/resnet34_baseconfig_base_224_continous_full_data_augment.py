...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/coco/image',
            ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/coco/annotation/instance_all.json',
            split='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/trainlist.txt',
    ...
    val=dict(
        ...
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/coco/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/coco/annotation/instance_all.json',
        split='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/testlist.txt',
    ...
    test=[dict(
        ...
        img_dir='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/coco/image',
        ann_file='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/coco/annotation/instance_all.json',
        split='/opt/data/private/project/charelchen.cj/workDir/dataset/whzx_ICH/extendlist.txt',
        pipeline=test_pipeline,
        ),]
)
    # test=dict(
    ...
    #     pipeline=test_pipeline,
    #     ))
evaluation = dict(interval=10, metric=['accuracy', 'precision', 'recall', 'f1_score', 'support', 'auc'])
...
log_level = 'INFO'
load_from = '/opt/data/private/project/charelchen.cj/workDir/dataset/mmclassifcation_pretrained_model/resnet34_batch256_imagenet_20200708-32ffb4f7.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/whzx_ich_resnet34_baseconfig_base_224_continous_full_data_augment'
