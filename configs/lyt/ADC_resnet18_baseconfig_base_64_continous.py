...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        type=dataset_type,
        img_dir='/gruntdata1/charelchen.cj/ProcessingData/coco/ADC/image',
        ann_file='/gruntdata1/charelchen.cj/ProcessingData/coco/ADC/annotation/instance_all.json',
...
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/lyt_resnet18_baseconfig_base_64_continous'
