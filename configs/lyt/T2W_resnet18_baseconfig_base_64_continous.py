...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
        type=dataset_type,
        img_dir='/gruntdata1/charelchen.cj/ProcessingData/coco/T2W/image',
        ann_file='/gruntdata1/charelchen.cj/ProcessingData/coco/T2W/annotation/instance_all.json',
        split='/gruntdata1/charelchen.cj/ProcessingData/train_list.txt',
    ...
    val=dict(
        ...
        img_dir='/gruntdata1/charelchen.cj/ProcessingData/coco/T2W/image',
        ann_file='/gruntdata1/charelchen.cj/ProcessingData/coco/T2W/annotation/instance_all.json',
        split='/gruntdata1/charelchen.cj/ProcessingData/test_list.txt',
    ...
    test=[dict(
        ...
        img_dir='/gruntdata1/charelchen.cj/ProcessingData/coco/T2W/image',
        ann_file='/gruntdata1/charelchen.cj/ProcessingData/coco/T2W/annotation/instance_all.json',
        split='/gruntdata1/charelchen.cj/ProcessingData/extend_list.txt',
        pipeline=test_pipeline,
        ),]
)
...
resume_from = None
workflow = [('train', 1)]
work_dir = 'work_dirs/lyt_T2W_resnet18_baseconfig_base_64_continous'
