...
data = dict(
    ...
    train=dict(
        ...
        img_dir='/gruntdata/charelchen.cj/workDir/dataset/whtj_lung/origin_nifty_resample_median',
        ann_dir='/gruntdata/charelchen.cj/workDir/dataset/whtj_lung/origin_nifty_resample_median',
