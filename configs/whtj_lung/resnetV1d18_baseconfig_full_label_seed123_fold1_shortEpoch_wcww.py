...
data = dict(
    ...
    train=dict(
        ...
        split='/gruntdata/charelchen.cj/workDir/dataset/whtj_lung/cross_validation_seed/123/train_1.txt',
    ...
    val=dict(
        ...
        img_dir='/gruntdata/charelchen.cj/workDir/dataset/whtj_lung/origin_nifty_resample_median_full_label',
        ann_dir='/gruntdata/charelchen.cj/workDir/dataset/whtj_lung/origin_nifty_resample_median_full_label',
        split='/gruntdata/charelchen.cj/workDir/dataset/whtj_lung/cross_validation_seed/123/val_1.txt',
