...
train_pipeline = [
    ...
    dict(type='RandomFlipMedical', prob=0.2, direction=0),
    dict(type='RandomFlipMedical', prob=0.2, direction=1),
    dict(type='RandomFlipMedical', prob=0.2, direction=2),
...
# learning policy
lr_config = dict(policy='step', step=[60, 125, 175])
