...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_dir='/gruntdata2/workDir/dataset/hnxy_lung/coco/image',
        ann_file='/gruntdata2/workDir/dataset/hnxy_lung/coco/annotation/instance_all.json',
        split='/gruntdata2/workDir/dataset/hnxy_lung/coco/train_folder_0.txt',
    ...
    val=dict(
        ...
        img_dir='/gruntdata2/workDir/dataset/hnxy_lung/coco/image',
        ann_file='/gruntdata2/workDir/dataset/hnxy_lung/coco/annotation/instance_all.json',
        split='/gruntdata2/workDir/dataset/hnxy_lung/coco/test_folder_0.txt',
...
resume_from = None
work_dir = 'work_dir/hnxy_lung_resnet34_baseconfig_small_224_continous'
workflow = [('train', 1)]
