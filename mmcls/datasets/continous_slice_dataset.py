...
class ContinousSliceDataset(BaseDataset):
    ...
    def get_patient_labels_and_preds(self, results, metric_options):
        ...
        return pred_per_patient, gt_per_patient
    ...
    def evaluate_per_patient(self,
        ...
        eval_results = {}
        results, gt_labels_per_patient = self.get_patient_labels_and_preds(results, metric_options)
